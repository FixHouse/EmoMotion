...
export const MetaTags: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const descUA = 'Авторська студія танцю та самовираження для дітей 2,5-8 років у Празі. Маленькі групи, анти-булінг підхід, заняття 150 крон. Кожна дитина знаходить свою суперсилу через рух!';
    const descCS = 'Autorské studio tance a sebevyjádření pro děti 2,5-8 let v Praze. Malé skupiny, anti-šikanový přístup, lekce za 150 Kč. Každé dítě najde svou superschopnost pohybem!';
